...
probability_pipeline.fit(frame, [0.0, 1.0])
probabilities: mw.Frame = probability_pipeline.predict_proba(frame)
portable_automl: mw.AutoML = mw.AutoML.classifier().deployability("onnx")
